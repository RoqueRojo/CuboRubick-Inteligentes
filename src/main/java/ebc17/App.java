...
public class App {
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, ParseException {
        ...
        double [] contador =new double [6];
        prob.getEstadoInicial().contarColoresCara("LEFT", contador);
        System.out.println(prob.getEstadoInicial().getHeuristica());
//        System.out.println(Math.log(entropia));
      for (int i = 0; i <contador.length; i++) {
           System.out.println(contador[i]);
        }
       
//        System.out.println(prob.getEstadoInicial().toString());
...
//        System.out.println(prob.getEstadoInicial().toString());
//        System.out.println(prob.getEstadoInicial().getID());
//        prob.getEstadoInicial().moveb(5);
//        System.out.println(prob.getEstadoInicial().toString());
//        System.out.println(prob.getEstadoInicial().getID());
//        prob.getEstadoInicial().movel(2);
//        System.out.println(prob.getEstadoInicial().toString());
//        System.out.println(prob.getEstadoInicial().getID());
//        prob.getEstadoInicial().moved(1);
//        System.out.println(prob.getEstadoInicial().toString());
...
////            } else {
////                System.out.println(nodoarbol.getAccion() + " f=" + nodoarbol.getF() + " P=" + nodoarbol.getP() + " C=" + nodoarbol.getCoste());
////                System.out.println(nodoarbol.getEstado().getID());
////            }
////            System.out.println("");
////            i++;
